...
const NewTrending = () => {
          ...
          <div key={category} className="mb-12 mt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
              {visibleItems.map((product) => (
                <div
                  key={product.id}
                  className="relative group bg-white overflow-hidden   shadow hover:shadow-xl transition-all"
                >
  ...
  className="bg-white p-2 rounded-full shadow hover:bg-red-500 text-gray-600 hover:text-white transition transform opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 duration-300 delay-100"
>
...
<Link
  ...
  className="bg-white p-2 rounded-full shadow hover:bg-red-500 text-gray-600 hover:text-white transition transform opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 duration-300 delay-200"
>
  <Eye size={16} />
</Link>
...
<button
  ...
  className="bg-white p-2 rounded-full shadow hover:bg-red-500 text-gray-600 hover:text-white transition transform opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 duration-300 delay-300"
>
  <Heart size={16} />
</button>

<button
  className="bg-white p-2 rounded-full shadow hover:bg-red-500 text-gray-600 hover:text-white transition transform opacity-0 translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 duration-300 delay-400"
>
  <RefreshCcw size={16} />
</button>
                    </div>
